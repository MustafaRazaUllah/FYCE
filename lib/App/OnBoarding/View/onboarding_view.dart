                ...
                children: [
                    ...
                    children: List.generate(
                      ...
                      (index) => Obx(() {
                        return Container(
                          ...
                          width: onBoardingVM.selectedPageIndex.value == index
                              ? SizeConfig.screenWidth * 0.1
                              : 10,
                          height: 10,
                          decoration: BoxDecoration(
                            color: onBoardingVM.selectedPageIndex.value == index
                                ? AppColor.onboard
                                : AppColor.greyText,
                  ...
                  Expanded(
                    child: CarouselSlider(
                      carouselController: onBoardingVM.buttonCarouselController,
