...
class ForgotPhoneVerification extends StatelessWidget {
  ForgotPhoneVerification({Key? key}) : super(key: key);

  final _serviceVM = Get.find<ForgetViewModel>();
  // final _serviceVM = Get.put(ForgetViewModel());
